...
const PlayControls = () => {
    return (
        <div className="flex justify-center gap-4">
            ...
            <button className="p-2 rounded flex justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
            ...
            <button className="p-2 rounded"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
